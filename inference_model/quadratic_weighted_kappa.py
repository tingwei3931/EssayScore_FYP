# Taken from Ben Hammer's implementation of Quadratic Weighted Kappa (QWK) for Kaggle. https://github.com/benhamner/ASAP-AES/blob/master/Evaluation_Metrics/Python/score/score.py
